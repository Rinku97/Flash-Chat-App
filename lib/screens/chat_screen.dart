  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text('💬️ Chatting...')),
      ...
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            MessagesStream(),
            Container(
              decoration: kMessageContainerDecoration.copyWith(color: Colors.black),
              child: Row(
    ...
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          for (var message in messages) {
            ...
            final currentlyUser = loggedInUser.email;

            final messageBubble = MessageBubble(
              sender: messageSender,
              text: messageText,
              isMe: currentlyUser == messageSender,
            );
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Material(
            ...
            elevation: 5.0,
            color: isMe ? Colors.black : Colors.teal,
            child: Padding(
